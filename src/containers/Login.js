...
export default class Login {
  constructor({
    ...
    const formEmployee = this.document.querySelector(
      `[data-testid="form-employee"]`
    );
    formEmployee.addEventListener("submit", this.handleSubmitEmployee);
    const formAdmin = this.document.querySelector(`[data-testid="form-admin"]`);
  ...
  handleSubmitAdmin = (e) => {
    e.preventDefault();
    // Les queries selectors de l'émail et du password étaient incorrectes: ils étaient sur employees-(email/password)-input
    const user = {
      type: "Admin",
